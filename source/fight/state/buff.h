...
#define lambda_Skill_Handler []([[maybe_unused]] ::Fight::State::State&state,[[maybe_unused]] ::Fight::State::Hid hid,[[maybe_unused]] s2 sid,[[maybe_unused]] const Arg_t_6&arg,[[maybe_unused]] const Arg_t_5&st)->s2
